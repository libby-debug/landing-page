...
export const tcoSections: TcoSection[] = [
  {
    ...
    checklistItems: [
      ...
      "A.2. Explain philosophical assumptions (selectionism, determinism, empiricism, parsimony, pragmatism, and philosophic doubt).",
      "A.3. Explain behavior from the perspectives of methodological behaviorism, radical behaviorism, and private events.",
      "A.4. Distinguish among behaviorism, EAB, ABA, and professional practice.",
      "A.5. Identify and describe the seven dimensions of ABA and socially significant behavior.",
    ],
  },
  {
    code: "B",
  ...
  },
  {
    ...
    progress: 0,
    checklistItems: [
      "E.1. Apply BACB Ethics Code foundations and core principles.",
      "E.2. Identify risks from unethical behavior to clients, supervisees, practitioners, organizations, and the profession.",
      "E.3. Maintain scope of competence, scope of practice, credentials, accountability, documentation, and records.",
      "E.4. Protect client dignity, rights, consent, assent, confidentiality, privacy, and welfare.",
      "E.5. Use ethical public statements, social media, advertising, and professional conduct.",
      "E.6. Discontinue or transition services and supervision ethically while avoiding abandonment.",
      "E.7. Manage conflicts of interest, multiple relationships, professional boundaries, gifts, finances, and exploitation risks.",
      "E.8. Use interpersonal skills including active listening, feedback acceptance, respectful communication, and collaboration.",
      "E.9. Apply cultural responsiveness, inclusivity, evidence-based practice, and least restrictive effective procedures.",
      "E.10. Apply ethical supervision, delegation, oversight, feedback, treatment integrity, and documentation responsibilities.",
      "E.11. Identify personal biases and protect professional judgment and client welfare.",
      "E.12. Follow applicable laws, regulations, mandated reporting, policies, documentation rules, and practice requirements.",
    ],
  },
  {
    code: "F",
